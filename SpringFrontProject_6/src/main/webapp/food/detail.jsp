...
<!-- <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=c19738365435a82b76feaff6121494c4&libraries=services"></script> -->
</head>
<body>
  <div class="container">
    <div class="row">
      ...
      <table class="table">
        ...
        <tr>
          <td class="text-right">
            ...
            onclick="javascropt:history.back()">
          </td>
        </tr>
      </table>
    </div>
   ...
   let detailApp=Vue.createApp({
	   ...
	   methods:{
		   addScript(){
			   ...
			   script.src="http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=c19738365435a82b76feaff6121494c4&libraries=services"
